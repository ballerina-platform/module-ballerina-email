...
# Introduction
This is the specification for Email standard library which is used for sending and
receiving emails using SMTP, POP3, and IMAP protocols programmed in the
